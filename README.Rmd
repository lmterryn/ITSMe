...
(https://github.com/InverseTampere/TreeQSM). The tree point cloud based 
...
\emph{plot_dbh_fit_pcs} and \emph{plot_dab_fit_pcs} functions. The 
\emph{plot_dab_fit_pcs} function can also be used to optimise the parameters by 
changing them and visually checking the results. This is also the case for 
\emph{plot_crown_classification_pcs} and \emph{plot_pca_pcs}.
