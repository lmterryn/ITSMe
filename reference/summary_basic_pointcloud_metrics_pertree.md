...
diameter above buttresses, projected (crown) area and (crown) volume of
one tree.
...
- h_cutoff:
  ...
  Numeric value (default=15), height threshold where dab is measured
  when buttress == TRUE.
...
- OUT_path:
  ...
  should be saved or logical (default=FALSE) in this case no figures are
  saved.
