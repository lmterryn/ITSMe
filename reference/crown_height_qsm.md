...
The crown height is defined as "the vertical distance between the
highest and the lowest crown cylinder relative to the tree height"
(Akerblom et al., 2017 & Terryn et al., 2020). The tree height is
calculated with
