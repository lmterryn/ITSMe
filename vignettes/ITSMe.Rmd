...
`tree_height_pc` only needs the tree point cloud as an input. For UAV-LS, 
sample lower parts of the stem, tree height can be based on a digital terrain model
```{r eval = FALSE}
